...
yolo_sub = message_filters.Subscriber("/darknet_ros/bounding_boxes", BoundingBoxes, queue_size=1)
ts = message_filters.ApproximateTimeSynchronizer([scan_sub, image_sub,yolo_sub], 10, time_diff)
